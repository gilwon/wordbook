      ...
      <div className="w-full max-w-sm flex flex-col gap-3">
        ...
        {LANGUAGES.map((lang) => (
          <button
            ...
            className="flex items-center gap-4 w-full bg-white dark:bg-gray-800 rounded-2xl border-2 border-gray-100 dark:border-gray-700 px-6 py-4 hover:border-indigo-400 hover:shadow-md transition-all group"
          >
            ...
            <div className="text-left">
              ...
              <p className="text-sm text-gray-400 dark:text-gray-500">{LANG_DESCRIPTIONS[lang]}</p>
            </div>
          </button>
        ))}
      </div>
